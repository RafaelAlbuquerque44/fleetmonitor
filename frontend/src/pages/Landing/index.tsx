            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="w-full md:w-[calc((100%-2rem)/2)] lg:w-[calc((100%-4rem)/3)] group relative p-8 md:p-10 bg-white dark:bg-[#112340] rounded-[32px] shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-100 dark:border-white/5 hover:border-blue-500/30 dark:hover:border-blue-500/50 flex flex-col overflow-hidden"
                >
